...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-12-2014 a las 17:20:53
...
INSERT INTO `background` (`idBackground`, `idPerson`, `company`, `jobTitle`, `dateFrom`, `dateTo`, `comment`) VALUES
(1, 2, 'scf', 'asdf', '1970-01-01', '1970-01-01', 'asdf'),
(2, 2, 'bueno', 'ksks', '1970-01-01', '1970-01-01', ''),
(3, 20, 'cme', 'ing', '1970-01-01', '1970-01-01', ''),
(4, 20, 'sadf', 'asdf', '1970-01-01', '1970-01-01', 'asdf'),
(5, 8, 'agrego', 'unpo', '1970-01-01', '1970-01-01', ''),
(6, 8, 'ASDF', 'asdf', '1970-01-01', '1970-01-01', ''),
(7, 14, 'hola', 'adsf', '1970-01-01', '1970-01-01', 'gffff'),
(8, 14, 'ASDf', 'asdf', '2014-12-09', '1970-01-01', 'asfd'),
(9, 14, 'ASdsd', 'asd', '1970-01-01', '1970-01-01', ''),
(10, 14, '', '', '1970-01-01', '1970-01-01', ''),
(11, 14, 'sadfg', 'sdfg', '1970-01-01', '1970-01-01', ''),
(12, 24, 'cme', 'progama', '1970-01-01', '1970-01-01', 'pasante'),
(13, 24, 'ospac', 'adm', '1970-01-01', '1970-01-01', 'asdf'),
(14, 26, 'ASDf', 'asdf', '1970-01-01', '1970-01-01', 'asdf'),
(15, 26, 'ASDf', 'asdf', '1970-01-01', '1970-01-01', ''),
(16, 27, 'cme', 'wqerwe', '1970-01-01', '1970-01-01', ''),
(17, 27, 'qwer', 'qwer', '1970-01-01', '1970-01-01', 'qwer'),
(18, 28, 'pepe', 'analyst', '1970-01-01', '1970-01-01', 'fsdfsdef'),
(19, 28, 'gdfgd', 'fgdgf', '1970-01-01', '1970-01-01', 'fd');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `bcheck`
--

CREATE TABLE IF NOT EXISTS `bcheck` (
`idBCheck` int(11) NOT NULL,
  `idPerson` int(11) NOT NULL,
  `bcra` blob NOT NULL,
  `cca` blob NOT NULL,
  `addressv` blob NOT NULL,
  `criminalv` blob NOT NULL,
  `ssnt` blob NOT NULL,
  `cev` blob NOT NULL,
  `academicv` blob NOT NULL,
  `financialc` blob NOT NULL,
  `hipaaa` blob NOT NULL
...
INSERT INTO `city` (`idCity`, `idProvince`, `name`) VALUES
(1, 1, '25 de Mayo'),
(2, 1, '3 de febrero'),
(3, 1, 'A. Alsina'),
...
INSERT INTO `education` (`idEducation`, `idPerson`, `level`, `institute`, `major`, `year`, `score`, `startDate`, `endDate`) VALUES
(1, 20, 'technical', 'qwerqwer', 'asdf', '1234', '1234', '1970-01-01', '1970-01-01'),
(2, 20, 'high school', '1234', 'qwer', '1234', '1234', '1970-01-01', '1970-01-01'),
(3, 24, 'technical', '1234', 'claudioeducation', '123', '1234', '1970-01-01', '1970-01-01'),
(4, 24, 'university', 'sad', 'claudioeducation2', 'asdf', 'asdf', '1970-01-01', '1970-01-01'),
(5, 26, 'high school', '1234', 'asdf', '314', '1234', '1970-01-01', '1970-01-01'),
(6, 27, 'high school', '123', 'qwer', '12332', '123', '1970-01-01', '1970-01-01'),
(7, 27, 'technical', '123', '123', '123', '123', '1970-01-01', '1970-01-01'),
(8, 28, 'university', 'tgdgfdfg', 'analyst', '2014', '8.5', '1970-01-01', '1970-01-01'),
(9, 28, 'elementary school', 'gf', 'bvcvb', 'bcv', '555', '1970-01-01', '1970-01-01');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `emergencycontact`
--

CREATE TABLE IF NOT EXISTS `emergencycontact` (
`idEC` int(11) NOT NULL,
  `idPerson` int(11) DEFAULT '2',
  `fullName` varchar(250) NOT NULL,
  `relationship` varchar(250) NOT NULL,
  `movile` varchar(255) NOT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=13 ;

--
-- Volcado de datos para la tabla `emergencycontact`
--

INSERT INTO `emergencycontact` (`idEC`, `idPerson`, `fullName`, `relationship`, `movile`) VALUES
(1, 2, 'asd', 'asd', '123'),
(2, 2, 'nombre', 'hijo', '123'),
(3, NULL, 'asdasd', 'asdsd', '12334554'),
(4, NULL, 'ads', 'asd', '13'),
(5, NULL, 'asf', 'sadf', '888898'),
(6, NULL, 'asf', 'sadf', '888898'),
(7, NULL, 'tyu', 'tyu', '789798'),
(8, NULL, 'qwe', 'qwe', '6598'),
(9, NULL, 'asd', 'asd', '132'),
(10, NULL, 'cffzv', 'sdf', '333'),
(11, 26, 'ljkhl', 'ñljkh', '666'),
(12, 28, 'peep', 'father', '213131');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `familymember`
--
...
--
-- Volcado de datos para la tabla `familymember`
--

INSERT INTO `familymember` (`idFM`, `idPerson`, `fullName`, `nationality`, `relationship`, `idType`, `idNumber`, `birthdate`) VALUES
(1, NULL, 'asd', '1', 'asd', 'DU', 23113, '1970-01-01'),
(2, NULL, 'asd', '1', 'hijo', 'DU', 123, '1970-01-01'),
(3, NULL, 'fbhdtyh', '1', 'tbnrtuyn', 'DU', 12123, '1970-01-01'),
(5, 14, 'asd', '1', 'asd', 'DU', 98, '1970-01-01'),
(6, NULL, 'asd', '1', 'asd', 'Passport', 5556, '1970-01-01'),
(7, NULL, 'qwe', '2', 'qwe', 'Passport', 124234, '1970-01-01');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `levelskill`
--

CREATE TABLE IF NOT EXISTS `levelskill` (
`idLevel` int(11) NOT NULL,
  `nameLevel` varchar(255) NOT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4 ;

--
-- Volcado de datos para la tabla `levelskill`
--

INSERT INTO `levelskill` (`idLevel`, `nameLevel`) VALUES
(1, 'Advanced'),
(2, 'Intermediate'),
(3, 'Basic');
...
INSERT INTO `maritalstatus` (`idMaritalStatus`, `name`) VALUES
(1, 'Single'),
(2, 'Married'),
(3, 'Widowed'),
(4, 'Separated'),
...
INSERT INTO `person` (`idPerson`, `firstname`, `middlename`, `lastname`, `photograph`, `idType`, `idNumber`, `cuil`, `gender`, `maritalStatus`, `nationality`, `birthDate`, `address1`, `address2`, `city`, `province`, `zipCode`, `country`, `phone`, `movile`, `workphone`, `workemail`, `email`, `state`) VALUES
(1, 'vghjc', 'dfgh', 'dfgh', NULL, 'Passport', 4567, '54', 'Female', 'married', '1', '1970-01-01', 'fgdh', 'dfty', 445, '6', 4566, 1, '456', '456', '456', 'example@domain.com', 'example@domain.com', 'internal'),
(2, 'asdf', 'asdf', 'asdfa', NULL, 'Passport', 33542, '435', 'Male', 'widowed', '1', '1970-01-01', '2345', '2345', 294, '3', 234, 1, '2345', '2345', '3245', 'example@domain.com', 'example@domain.com', 'internal');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `personsecurity`
--

CREATE TABLE IF NOT EXISTS `personsecurity` (
  `idPerson` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `personskill`
--

CREATE TABLE IF NOT EXISTS `personskill` (
`idPersonSkill` int(20) NOT NULL,
  `idPerson` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `personskill`
--

INSERT INTO `personskill` (`idPersonSkill`, `idPerson`, `idSkill`, `idLevel`) VALUES
(14, 4, 15, 1),
(16, 2, 12, 1),
(17, 2, 13, 1),
(18, 2, 46, 1),
...
CREATE TABLE IF NOT EXISTS `province` (
  `idCountry` int(11) NOT NULL DEFAULT '1',
...
INSERT INTO `province` (`idCountry`, `idProvince`, `name`) VALUES
(1, 1, 'Buenos Aires'),
...
INSERT INTO `skills` (`idSkill`, `idTypeSkill`, `nameSkill`) VALUES
(1, 1, 'Test Cases Creation\r'),
(2, 1, 'Regression Test\r'),
(3, 1, 'Smoke Testing\r'),
(4, 1, 'Automated testing\r'),
(5, 1, 'Stress testing\r'),
(6, 1, ' Load testing\r'),
(7, 1, 'Security  test\r'),
(8, 1, 'Accessibility test\r'),
(9, 1, 'TrackWeb Management\r'),
(10, 1, 'Analysis, Structured design, object-oriented.\r'),
(11, 1, 'Junit testing\r'),
(12, 2, 'Windows\r'),
(13, 2, 'Linux: Ubuntu \r'),
(14, 2, 'Linux: Debian\r'),
(15, 3, 'MySQL:\r'),
...
(26, 4, 'JAVA\r'),
(27, 4, 'Hibernate\r'),
(28, 4, 'Spring Framework 2\r'),
(29, 4, 'Spring Framework 3\r'),
(30, 4, 'PHP\r'),
(31, 4, 'Android\r'),
(32, 4, 'IOS\r'),
(33, 4, 'XML\r'),
...
(47, 5, 'Netbeans\r'),
(48, 5, 'Jdeveloper\r'),
(49, 5, 'PHP Profetional\r'),
(50, 5, 'Macromedia package and CS3\r'),
(51, 5, 'Report Builder\r'),
(52, 5, 'Form Builder\r'),
(53, 5, 'Zend Studio\r'),
(54, 5, 'JBoss\r'),
(55, 5, 'Apache Tomcat5\r'),
(56, 5, 'Apache Tomcat6\r'),
(57, 5, 'Liferay\r'),
(58, 5, 'Symfony\r'),
(59, 5, 'Joomla\r'),
(60, 5, 'FLEX Builder\r'),
(61, 5, 'Visual Studio 2012\r'),
(62, 5, 'Sql Server Management Studio\r'),
(63, 5, 'Microsoft SQL Server 2008 R2\r'),
(64, 6, 'SVN\r'),
(65, 6, 'Git\r'),
(66, 6, 'CVS\r'),
(67, 7, 'Microsoft Project: \r'),
(68, 7, 'Jira\r'),
(69, 8, 'Rational Rose - UML\r'),
(70, 8, 'Microsoft Visio\r'),
(71, 9, 'Kanban\r'),
(72, 9, 'Scrum\r'),
(73, 10, 'ISO 9001:2000.\r'),
(74, 10, 'CMMI maturity level 2.\r'),
(76, 11, 'Oral\r'),
(77, 11, 'Written\r');
...
`idStaff` int(20) NOT NULL,
  ...
  `healthInsurance` varchar(255) DEFAULT NULL
...
INSERT INTO `staff` (`idStaff`, `idPerson`, `dateFrom`, `dateTo`, `salary`, `tasks`, `workspace`, `agreement`, `category`, `healthInsurance`) VALUES
(1, 2, '1970-01-01', '1970-01-01', 0, '', '', '', '', ''),
(3, 1, '1970-01-01', '1970-01-01', 0, '', '', '', '', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `supplementaryinfo`
--

CREATE TABLE IF NOT EXISTS `supplementaryinfo` (
`idSI` int(11) NOT NULL,
  `idPerson` int(11) DEFAULT '2',
  `operation` varchar(1) DEFAULT NULL,
  `opAmount` int(11) NOT NULL,
  `opCauses` varchar(255) NOT NULL,
  `allergy` varchar(255) NOT NULL,
  `preexDiseases` varchar(255) NOT NULL,
  `bloodType` varchar(255) NOT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=3 ;

--
-- Volcado de datos para la tabla `supplementaryinfo`
--

INSERT INTO `supplementaryinfo` (`idSI`, `idPerson`, `operation`, `opAmount`, `opCauses`, `allergy`, `preexDiseases`, `bloodType`) VALUES
(1, NULL, '', 1, '1', 'asdfcsadf', 'asd', 'Group O?'),
(2, 14, '', 1, 'qwe', 'qwe', 'qwe', 'Group AB+');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `typeskill`
--

CREATE TABLE IF NOT EXISTS `typeskill` (
`idTypeSkill` int(11) NOT NULL,
  `nameType` varchar(255) NOT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=12 ;

--
-- Volcado de datos para la tabla `typeskill`
--

INSERT INTO `typeskill` (`idTypeSkill`, `nameType`) VALUES
(1, 'Quality Assurance'),
(2, 'S.O'),
(3, ' Databases'),
...
--
-- Indices de la tabla `bcheck`
--
ALTER TABLE `bcheck`
 ADD PRIMARY KEY (`idBCheck`);
...
--
-- Indices de la tabla `emergencycontact`
--
ALTER TABLE `emergencycontact`
 ADD PRIMARY KEY (`idEC`);

--
-- Indices de la tabla `familymember`
--
ALTER TABLE `familymember`
 ADD PRIMARY KEY (`idFM`), ADD UNIQUE KEY `idNumber` (`idNumber`);

--
-- Indices de la tabla `levelskill`
--
...
ALTER TABLE `maritalstatus`
 ADD PRIMARY KEY (`idMaritalStatus`);
...
--
-- Indices de la tabla `personskill`
--
ALTER TABLE `personskill`
 ADD PRIMARY KEY (`idPersonSkill`);
...
--
ALTER TABLE `staff`
 ADD PRIMARY KEY (`idStaff`), ADD UNIQUE KEY `idPerson` (`idPerson`);

--
-- Indices de la tabla `supplementaryinfo`
--
ALTER TABLE `supplementaryinfo`
 ADD PRIMARY KEY (`idSI`);

--
-- Indices de la tabla `typeskill`
--
ALTER TABLE `typeskill`
 ADD PRIMARY KEY (`idTypeSkill`);
...
--
ALTER TABLE `background`
MODIFY `idBackground` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=20;
--
-- AUTO_INCREMENT de la tabla `bcheck`
--
ALTER TABLE `bcheck`
MODIFY `idBCheck` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `city`
--
ALTER TABLE `city`
MODIFY `idCity` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2383;
--
...
--
ALTER TABLE `education`
MODIFY `idEducation` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT de la tabla `emergencycontact`
--
ALTER TABLE `emergencycontact`
MODIFY `idEC` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT de la tabla `familymember`
--
ALTER TABLE `familymember`
MODIFY `idFM` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT de la tabla `levelskill`
--
ALTER TABLE `levelskill`
...
--
ALTER TABLE `maritalstatus`
MODIFY `idMaritalStatus` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
...
--
-- AUTO_INCREMENT de la tabla `personskill`
--
ALTER TABLE `personskill`
MODIFY `idPersonSkill` int(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=81;
--
-- AUTO_INCREMENT de la tabla `province`
--
ALTER TABLE `province`
MODIFY `idProvince` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=26;
--
-- AUTO_INCREMENT de la tabla `security`
--
ALTER TABLE `security`
MODIFY `idSecurity` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `skills`
--
ALTER TABLE `skills`
MODIFY `idSkill` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=78;
--
-- AUTO_INCREMENT de la tabla `staff`
--
ALTER TABLE `staff`
MODIFY `idStaff` int(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT de la tabla `supplementaryinfo`
--
ALTER TABLE `supplementaryinfo`
MODIFY `idSI` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de la tabla `typeskill`
--
ALTER TABLE `typeskill`
MODIFY `idTypeSkill` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=12;
